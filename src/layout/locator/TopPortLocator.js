 ...
 */
draw2d.layout.locator.TopPortLocator = draw2d.layout.locator.PortLocator.extend(
  /** @lends draw2d.layout.locator.TopPortLocator.prototype */
  {
  
  NAME: "draw2d.layout.locator.TopPortLocator",
